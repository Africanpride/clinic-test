<div
    class="sticky top-0 z-30 flex h-16 w-full justify-center bg-opacity-90
backdrop-blur transition-all duration-100 bg-base-100 text-base-content shadow-md">
    <nav class="navbar w-full">
        <div class="flex flex-1 md:gap-1 lg:gap-2"><span
                class="tooltip tooltip-bottom before:text-xs before:content-[attr(data-tip)]" data-tip="Menu"><label
                    for="drawer" class="btn btn-square btn-ghost drawer-button lg:hidden"><svg width="20"
        ...
        <div class="flex-0 flex items-center gap-2">
            ...
            <div class="dropdown dropdown-end">
                ...
                <label tabindex="0"
                    class="btn btn-ghost btn-circle avatar {{ Auth::check() == true ? 'online' : 'offline' }}">
                    <div class="w-10 rounded-full ">

                        <img src="{{ asset(Auth::user()?->profile_image) ?? asset('/images/avatar.png') }}">
                    </div>
                </label>
                ...
                <ul tabindex="0"
                    ...
                    <li><a href={{ route('profile') }} class="flex items-center justify-start  gap-2"> <span>
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a class="flex items-center  justify-start gap-2" href="route('logout')"
                                ...
                                <span>
                                    <x-iconsax-bro-logout class="text-current w-5 h-5" />
                                </span>

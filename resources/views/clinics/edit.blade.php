...
@section('content')
    ...
    <div class="panel panel-super2">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($clinic->name) ? $clinic->name : 'Clinic' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('clinics.clinic.update', $clinic->id) }}" id="edit_clinic_form" name="edit_clinic_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
